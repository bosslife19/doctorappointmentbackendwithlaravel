    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
        <div class="flex items-center gap-x-4">
          <img class="rounded-full size-20" src="https://images.pexels.com/photos/5215024/pexels-photo-5215024.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Image Description">
          <div class="grow">
            <h3 class="font-medium text-gray-800 dark:text-neutral-200">
              Dr. Lucy Michael
            </h3>
            <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
              Dermatology / Umuahia National Hospital
            </p>
          </div>
        </div>
        ...
        <div class='flex flex-col md:flex-row gap-3 md:gap-0 justify-between mt-5'>
                 <!-- Social Brands -->
        <div class="mt-3 space-x-1">
          ...
          <!-- End Social Brands -->
          @if (auth()->user() != null)
          <a class="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
            Book Appointment
          </a>
          @else
          <a class="py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="/login">
            Book Appointment
          </a>
          @endif
