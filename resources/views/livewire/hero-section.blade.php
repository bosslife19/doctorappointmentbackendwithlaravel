<div class="max-w-[85rem] mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Access Health care at your fingertips <span class="text-blue-600">Book Appointment</span></h1>
          <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Welcome! your one-stop solution for managing your health. Whether you need a quick consultation or a routin check-up, our website lets you book appointments with top-rated doctors at your convenience. Say goodbye to long waits and hello to seamless healthcare</p>
        ...
        <div class="relative ms-4">
          <img class="w-full rounded-md" src="https://images.pexels.com/photos/6749742/pexels-photo-6749742.jpeg?auto=compress&cs=tinysrgb&w=600" alt="doctor hero">
